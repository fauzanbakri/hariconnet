	...
	class MonitoringSLA extends CI_Controller
	{
		...
		private function buildHeaderMap($headerRow)
		{
			...
			$valid = [
				...
				'durasilaporanmenit',
				'waktugangguan2',
				'waktugangguanselesai',
				'durasigangguan',
				'durasigangguanmenit',
				'durasistopclock',
				'durasigangguaminusstopclock',
				'endcustomer',
				'durasistopclockpelanggan',
				'durasigangguanminusstopclockpelanggan',
				'keteranganclose',
				'segmenpelanggan',
				'bandwidth',
				'lastkomen',
		...
		private function mapRowToRecord($row, $headerMap)
		{
			...
			foreach ($headerMap as $col => $dbCol) {
				...
				if (in_array($dbCol, [
					'waktugangguan','waktugangguan2','waktulapor','waktulaporanselesai',
