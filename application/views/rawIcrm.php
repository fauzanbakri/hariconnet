                        ...
                        <div class="card-header">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <br>
                                    <div class="table-responsive">
                                        <h5 class="mb-sm-4 mt-sm-4">TOP TEN ROOTCAUSE GANGGUAN RITEL MAMUJU</h5>
                                        <table class="table table-nowrap table-striped-columns mb-0">
                                            <thead class="table-primary">
                                            <tr>
                                                <th rowspan="2">Penyebab Gangguan</th>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="PaluPage" role="tabpanel">
                                <div class="table-responsive">
                                        <h5 class="mb-sm-4 mt-sm-4">PENCAPAIAN MTTR RITEL PALU – PER KABUPATEN</h5>
                                        <table class="table table-nowrap table-striped-columns mb-0">
                                            <thead class="table-primary">
                                            <tr>
                                                <th rowspan="2">Kabupaten/Kota</th>
                                    ...
                                    <br>
                                    <div class="table-responsive">
                                        <h5 class="mb-sm-4 mt-sm-4">TOP TEN ROOTCAUSE GANGGUAN RITEL PALU</h5>
                                        <table class="table table-nowrap table-striped-columns mb-0">
                                            <thead class="table-primary">
                                            <tr>
                                                <th rowspan="2">Penyebab Gangguan</th>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="KendariPage" role="tabpanel">
                                <div class="table-responsive">
                                        <h5 class="mb-sm-4 mt-sm-4">PENCAPAIAN MTTR RITEL KENDARI – PER KABUPATEN</h5>
                                        <table class="table table-nowrap table-striped-columns mb-0">
                                            <thead class="table-primary">
                                            <tr>
                                                <th rowspan="2">Kabupaten/Kota</th>
                                    ...
                                    <br>
                                    <div class="table-responsive">
                                        <h5 class="mb-sm-4 mt-sm-4">TOP TEN ROOTCAUSE GANGGUAN RITEL KENDARI</h5>
                                        <table class="table table-nowrap table-striped-columns mb-0">
                                            <thead class="table-primary">
                                            <tr>
                                                <th rowspan="2">Penyebab Gangguan</th>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="GorontaloPage" role="tabpanel">
                                <div class="table-responsive">
                                        <h5 class="mb-sm-4 mt-sm-4">PENCAPAIAN MTTR RITEL GORONTALO – PER KABUPATEN</h5>
                                        <table class="table table-nowrap table-striped-columns mb-0">
                                            <thead class="table-primary">
                                            <tr>
                                                <th rowspan="2">Kabupaten/Kota</th>
                                    ...
                                    <br>
                                    <div class="table-responsive">
                                        <h5 class="mb-sm-4 mt-sm-4">TOP TEN ROOTCAUSE GANGGUAN RITEL GORONTALO</h5>
                                        <table class="table table-nowrap table-striped-columns mb-0">
                                            <thead class="table-primary">
                                            <tr>
                                                <th rowspan="2">Penyebab Gangguan</th>
                                        ...
                                        <tbody>
                                            <?php
                                                foreach($gorontalotop10_1 as $row){
                                                    echo '
                                                    <tr>
                                                        <td>'.$row->penyebab.'</td>
                                                        <td>'.$row->total_jan.'</td><td>'.$row->percentage_less_1_day_jan.'%</td>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            <?php
                                                foreach($gorontalotop10_2 as $row){
                                                    echo '
                                                    <tr>
                                                        <td>'.$row->penyebabdetail.'</td>
                                                        <td>'.$row->total_jan.'</td><td>'.$row->percentage_less_1_day_jan.'%</td>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="ManadoPage" role="tabpanel">
                                <div class="table-responsive">
                                        <h5 class="mb-sm-4 mt-sm-4">PENCAPAIAN MTTR RITEL MANADO – PER KABUPATEN</h5>
                                        <table class="table table-nowrap table-striped-columns mb-0">
                                            <thead class="table-primary">
                                            <tr>
                                                <th rowspan="2">Kabupaten/Kota</th>
                                    ...
                                    <br>
                                    <div class="table-responsive">
                                        <h5 class="mb-sm-4 mt-sm-4">TOP TEN ROOTCAUSE GANGGUAN RITEL MANADO</h5>
                                        <table class="table table-nowrap table-striped-columns mb-0">
                                            <thead class="table-primary">
                                            <tr>
                                                <th rowspan="2">Penyebab Gangguan</th>
