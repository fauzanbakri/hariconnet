                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Ticket Close</h5><br>
                                ...
                                <div class="card-body">
                                    <table id="tiketclosetable" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Priority</th>
                                                <th>Insiden</th>
