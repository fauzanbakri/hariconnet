...
<body>
    ...
    <!-- jQuery (required by plugins like DataTables, Select2) -->
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                            ...
                            $_SESSION['role']=='Guest 1'
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidereport">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="Tickets" class="nav-link" data-key="t-analytics"> Retail</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="TicketsCorporate" class="nav-link" data-key="t-analytics"> Corporate</a>
                                            </li>
                                            <li class="nav-item">
                        ...
                        if(
                            ...
                            $_SESSION['role']=='Pemeliharaan Ritel'
                                ...
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="Basecamp" data-bs-toggle="" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidereport2">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a href="ShiftCorpo/showReport" class="nav-link" data-key="t-analytics"> Report Shift Corpo </a>
                                            </li>
                                            <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="MonitoringAreaMaterial" data-bs-toggle="" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                                <i class="mdi mdi-map-marker-multiple"></i> <span data-key="t-layouts">Monitoring Area Material</span>
                            </a>
                        </li>
                         <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="KodeMaterial" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                                <i class="mdi mdi-format-list-bulleted"></i> <span>Kode Material</span>
                            </a>
                        </li>
                        <li class="nav-item">
